...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { balance: @bank.balance, name: @bank.name, nick: @bank.nick, number: @bank.number, user_id: @bank.user_id } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { balance: @bank.balance, name: @bank.name, nick: @bank.nick, number: @bank.number, user_id: @bank.user_id } }
